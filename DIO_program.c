...
void DIO_vidSetPortDirection(u8 u8PortNumber, u8 u8PortDirection)
{
    switch(u8PortNumber)
    {
        case DIO_PORTA:
            TRISA = u8PortDirection;
            break;
        case DIO_PORTB:
            TRISB = u8PortDirection;
            break;
        case DIO_PORTC:
            TRISC = u8PortDirection;
            break;
        case DIO_PORTD:
            TRISD = u8PortDirection;
            break;
        case DIO_PORTE:
            TRISE = u8PortDirection;
    }
}
